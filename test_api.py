...
def test_create_lambda_with_timer_trigger():
    output_str = os.run_command('cd lambda_with_timer_trigger; rm -rf vendor/; git clone https://github.com/zach-oliver/pymadeeasy.git vendor/; chalice deploy', bool_output=True)
